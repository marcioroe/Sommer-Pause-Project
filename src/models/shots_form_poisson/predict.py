...
def predict_score(
    ...
    Same decision rule as the other Poisson models: weighs every
    candidate scoreline by the Kicktipp points it would earn against
    every possible actual outcome, scaled by how likely that outcome
    is, and picks the candidate with the highest expected payoff.
    ...
    Args:
        ...
        current_form: Output of features.compute_current_form(), giving
            each team's shots-on-target form heading into this match.
